...
screen -S taskbot -X screen -t default ./run.sh config_dev_2_6.py
screen -S taskbot -X screen -t default ./run.sh config_prod_2_6.py
screen -S taskbot -X screen -t default ./run.sh config_prod_3_0_0.py
screen -S taskbot -X screen -t default ./slow.sh config_dev_3_0_0.py
