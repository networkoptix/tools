...
screen -S taskbot -X screen -t vms_3.1.1 ./run.sh config_vms_3_1_1.py
screen -S taskbot -X screen -t vms_3.1.1_dev ./run.sh config_vms_3_1_1_dev.py
...
screen -S taskbot -X screen -t slow_vms_3.1.1 ./slow.sh config_vms_3_1_1.py
screen -S taskbot -X screen -t slow_vms_3.1.1_dev ./slow.sh config_vms_3_1_1_dev.py
...
screen -S taskbot -X screen -t nx1_vms_3.1.1_dev sh -c "cd $HOME/taskbot/devtools/taskbot/instances/nx1 && ./run.sh config_vms_3_1_1_dev.py"
