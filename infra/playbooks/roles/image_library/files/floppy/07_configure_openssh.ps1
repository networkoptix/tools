# ==============================================================================
# NOTE:
# This file is extracted from configuration steps found in
# https://github.com/joefitzgerald/packer-windows
# There is no local history for following lines and we probably should revise
# these configuration steps.
# @iremizov: I have no clue about what's going on here but it seems that this
# script configures ssh correctly
# FIXME: We need to rewrite it and use choco install instead of manual juggling
# of exe and installation files.
# ==============================================================================
