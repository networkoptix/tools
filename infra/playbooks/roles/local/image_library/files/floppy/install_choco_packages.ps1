...
C:\ProgramData\chocolatey\choco.exe install dotnet3.5 --version 3.5.20160716 -y --verbose
C:\ProgramData\chocolatey\choco.exe install dotnet4.6.2 --version 4.6.01590.20170129 -y --verbose
C:\ProgramData\chocolatey\choco.exe install netfx-4.6.2-devpack --version 4.6.01590.20170129 -y --verbose
