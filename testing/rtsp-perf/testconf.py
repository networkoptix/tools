...
PROJECT_ROOT = "/home/test/develop/netoptix_vms/"
...
HG_CHECK_PERIOD = 10 * 60 # seconds, complete check period, including time consumed by check, builds and tests
...
FT_PIPE_TIMEOUT = 120 * 1000  # ... Functional tests' pipe timeout
...
MVN_THREADS = 10 # Number of threads to be used by maven (mvn -T)
SELF_RESTART_TIMEOUT = 10 # seconds

BRANCHES = ('dev_2.4.1','dev_2.5.0_gui', 'dev_2.5', 'prod_2.5', 'dev_3.0')
TESTS = ('common_ut', 'mediaserver_core_ut', 'client_ut')
...
HG = "/usr/bin/hg"
MVN = "/home/test/develop/buildenv/maven/bin/mvn"
