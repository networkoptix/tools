...
def create_project_by_id(project_id, input_state, in_assist_mode):
    for project in all_projects:
        if project.project_id == project_id:
            return project(input_state, in_assist_mode)
...
def run_project_stage(input_file_path, output_file_path):
    ...
    project = create_project_by_id(project_id, input_state, in_assist_mode)
    output_state = project.run(stage_id)
