...
class Deployer(object):
    ...
    def deploy_artifacts(self, customization_list, platform_list, build_info_path, version_path, platform_build_info_map):
        ...
        self._deploy_version_file(version_path, target_dir)
