...
class WindowsPlatform(Platform):
    ...
    def extract_core_backtrace(self, binary_path, dump_path):
        if not binary_path: return
        log.info('Extracting dump file backtrace from %s, generated by %s', dump_path, binary_path)
        return CdbSession(dump_path, binary_path).get_backtrace()
