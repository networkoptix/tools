...
{
    ApiBusinessRuleData():
        eventType(nx::vms::event::undefinedEvent),
        eventState(nx::vms::event::EventState::undefined),
        actionType(nx::vms::event::undefinedAction),
        aggregationPeriod(0),
        disabled(false),
        system(false)
    {
...
#define ApiBusinessRuleData_Fields ApiIdData_Fields \
    (eventType)(eventResourceIds)(eventCondition)(eventState)(actionType)(actionResourceIds) \
...
struct ApiBusinessActionData: ApiData
{
    ApiBusinessActionData():
        ApiData(),
        actionType(nx::vms::event::undefinedAction),
        toggleState(nx::vms::event::EventState::undefined),
...
#define ApiBusinessActionData_Fields (actionType)(toggleState)(receivedFromRemoteHost) \
    (resourceIds)(params)(runtimeParams)(ruleId)(aggregationCount)
