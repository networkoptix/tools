...
public final class ApidocTagParser
{
        ...
        throws Error
    {
        ...
        final String[] firstLineValues = Utils.matchRegex(commentEndRegex, sourceLine);
        if (firstLineValues != null) //< single line case
            sourceLine = firstLineValues[0];
    ...
    private static final Pattern emptyCommentLineRegex = Pattern.compile(
        "\\s*(?:/\\*)?\\*?/?\\s*\\\\?"); //< A trailing backslash can be used in C++ macros.
      //     /*       *   /
